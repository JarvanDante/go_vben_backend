...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben/node-utils": "/var/www/html/by_new/go_vben_backend/internal/node-utils"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("/var/www/html/by_new/go_vben_backend/internal/node-utils/src/index.js")} */
const _module = await jiti.import("/var/www/html/by_new/go_vben_backend/internal/node-utils/src/index.ts");
