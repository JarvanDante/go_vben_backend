...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben/vite-config": "/var/www/html/by_new/go_vben_backend/internal/vite-config"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("/var/www/html/by_new/go_vben_backend/internal/vite-config/src/index.js")} */
const _module = await jiti.import("/var/www/html/by_new/go_vben_backend/internal/vite-config/src/index.ts");
