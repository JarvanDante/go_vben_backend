...
/** @type {import("/var/www/html/by_new/go_vben_backend/packages/@core/base/shared/src/color/index.js")} */
const _module = await jiti.import("/var/www/html/by_new/go_vben_backend/packages/@core/base/shared/src/color/index.ts");
