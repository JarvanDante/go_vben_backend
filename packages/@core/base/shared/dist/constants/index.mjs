...
/** @type {import("/var/www/html/by_new/go_vben_backend/packages/@core/base/shared/src/constants/index.js")} */
const _module = await jiti.import("/var/www/html/by_new/go_vben_backend/packages/@core/base/shared/src/constants/index.ts");
